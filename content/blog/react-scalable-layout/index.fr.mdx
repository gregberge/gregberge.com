...
title: 'Créer des layouts scalable avec React'
date: '2019-12-18'
author: 'Greg Bergé'
published: true
...
Un téléporteur exposent deux composants : une "target" et une "source". Les éléments définis dans la "source" sont téléportés dans la "target".
